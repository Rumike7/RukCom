...
export class FakeBackendInterceptor implements HttpInterceptor {
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function getUserById() {
            ...
            const user = users.find((x:User) => x.id ===idFromUrl().toString());
        ...
        function updateUser() {
            ...
            let params = body;
            let user = users.find((x:User) => x.id === idFromUrl().toString());
        ...
        function deleteUser() {
            ...
            users = users.filter((x:User) => x.id !== idFromUrl().toString());
            localStorage.setItem(usersKey, JSON.stringify(users));
            return ok();
        }
